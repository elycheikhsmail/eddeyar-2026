...
const NavLink = ({
  ...
  <Link
    href={href}
    onClick={onClick}
    className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all font-bold text-[15px] ${active ? "bg-white/20 text-white" : "text-white/70 hover:text-white hover:bg-white/10"
      } ${className}`}
  >
    {children}
  </Link>
      ...
      <div className="relative inline-block text-left">
        ...
        {isOpen && (
          <>
            ...
            <div
              className={`absolute mt-2 w-40 z-40 rounded-xl bg-white text-gray-800 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none p-1 ${currentLocale === "ar" ? "left-0 origin-top-left" : "right-0 origin-top-right"
                }`}
            >
                ...
                {languages.map((lang) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group flex items-center justify-between w-full px-3 py-2 text-sm font-medium rounded-lg transition-colors ${isActive ? "bg-blue-50 text-blue-600" : "hover:bg-gray-100 text-gray-700"
                        }`}
                    >
      ...
      {languages.map((lang) => {
        ...
        return (
          <button
            ...
            className={`relative inline-flex items-center justify-center h-10 w-10 rounded-full bg-white text-lg leading-none shadow-sm ring-1 ring-gray-200 transition hover:ring-gray-300 ${isActive ? "ring-2 ring-blue-500" : "opacity-70 grayscale hover:grayscale-0 hover:opacity-100"
              }`}
          >
