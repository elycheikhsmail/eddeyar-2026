...
async def run_test():
    ...
    try:
        ...
        # -> Fill the keyword into the search input (index 121) and click the search button (index 122) to submit the search and trigger listing updates.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/main/div/div/div/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('عقار للإيجار نواكشوط')
