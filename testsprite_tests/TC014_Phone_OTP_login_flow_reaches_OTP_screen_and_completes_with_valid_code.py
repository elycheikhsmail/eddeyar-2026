...
async def run_test():
    ...
    try:
        ...
        # -> Fill a valid phone number into the phone input field (index 416) and submit the login form (click submit button index 425).
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the login/submit button to attempt phone-based login and trigger the OTP entry page.
        frame = context.pages[-1]
        # Click element
