...
async def run_test():
    ...
    try:
        ...
        # -> Fill the phone/email field (index 12) and password field (index 13) with default credentials and click the submit/login button (index 15).
        frame = context.pages[-1]
        # Input text
        ...
        # -> Attempt login using a phone number: fill phone (index 332) with 36000000, fill password (index 337) with password123, then click the submit button (index 342).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/main/div/form/div/input').nth(0)
        ...
        # -> Attempt to submit the login form again by clicking the submit button (index 342).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/main/div/form/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
